...
public class SmallerOrEqualExpression extends RelationalExpression {
    public SmallerOrEqualExpression(Expression leftExpression, Expression rightExpression) {
