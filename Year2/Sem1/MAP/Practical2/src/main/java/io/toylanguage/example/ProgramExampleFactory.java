...
//        programs.add(new ProgramExample(program11, "11", program11.toString(), "program11"));
        Statement programLock = programLock();
        programs.add(new ProgramExample(programLock, "1", programLock.toString(), "programLock"));
...
//    The final Out should be {190 or 199,350 or 305}
    private static Statement programLock() {
        return new StatementBuilder()
                .add(new DeclarationStatement("v1", new RefType(new IntType())))
                .add(new DeclarationStatement("v2", new RefType(new IntType())))
                .add(new DeclarationStatement("x", new IntType()))
                .add(new DeclarationStatement("q", new IntType()))
                .add(new HeapAllocation("v1", new ValueExpression(new IntValue(20))))
                .add(new HeapAllocation("v2", new ValueExpression(new IntValue(30))))
                        ...
                        new StatementBuilder()
                                .add(new ForkStatement(
                                        new StatementBuilder()
                                                ...
                                                .add(new HeapWrite("v1", new SubtractionExpression(
                                                        new HeapRead(new VariableExpression("v1")),
                                                        new ValueExpression(new IntValue(1)))))
                                                .add(new UnlockStatement("x"))
                                                .build()))
                                .add(new LockStatement("x"))
                                .add(new HeapWrite("v1", new MultiplicationExpression(
                                        new HeapRead(new VariableExpression("v1")), new ValueExpression(new IntValue(10)))))
                                .add(new UnlockStatement("x"))
                                .build()
                ))
                        ...
                        new StatementBuilder()
                                .add(new ForkStatement(
                                        new StatementBuilder()
                                                ...
                                                .add(new HeapWrite("v2", new AdditionExpression(
                                                        new HeapRead(new VariableExpression("v2")),
                                                        new ValueExpression(new IntValue(5)))))
                                                .add(new UnlockStatement("q"))
                                                .build()))
                                .add(new LockStatement("q"))
                                .add(new HeapWrite("v2", new MultiplicationExpression(
                                        new HeapRead(new VariableExpression("v2")), new ValueExpression(new IntValue(10)))))
                                .add(new UnlockStatement("q"))
                                .build()
                ))
                ...
                .add(new NopStatement())
                .add(new LockStatement("x"))
                .add(new PrintStatement(new HeapRead(new VariableExpression("v1"))))
                .add(new UnlockStatement("x"))
                .add(new LockStatement("q"))
                .add(new PrintStatement(new HeapRead(new VariableExpression("v2"))))
                .add(new UnlockStatement("q"))
                .build();
    }
